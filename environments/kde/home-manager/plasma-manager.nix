{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-008f6759-9a55-46dc-bb91-519ea4ca170b" = [ ];
      ...
      "services/org.kde.krunner.desktop"."_launch" = ["Search" "Alt+Space" "Alt+F2" "Meta+D"];
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2025,7,31,19,52,39.526";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."008f6759-9a55-46dc-bb91-519ea4ca170b" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "008f6759-9a55-46dc-bb91-519ea4ca170b";
      ...
      "katerc"."filetree"."editShade" = "95,89,134";
      ...
      "katerc"."filetree"."viewShade" = "95,89,134";
      ...
      "krunnerrc"."Plugins/Favorites"."plugins" = "krunner_sessions,windows,browsertabs,krunner_services,browserhistory,krunner_powerdevil,krunner_systemsettings";
      ...
      "kuriikwsfilterrc"."General"."PreferredWebShortcuts" = "google,wikit,yahoo,youtube,wikipedia";
      "kuriikwsfilterrc"."General"."UsePreferredWebShortcutsOnly" = false;
      "kwalletrc"."Wallet"."First Use" = false;
      "kwinrc"."Activities/LastVirtualDesktop"."008f6759-9a55-46dc-bb91-519ea4ca170b" = "e2c279af-7567-41de-8f0f-4372a595b944";
      "kwinrc"."Desktops"."Id_1" = "e2c279af-7567-41de-8f0f-4372a595b944";
      "kwinrc"."Desktops"."Id_2" = "16606567-2f97-4828-9202-fd3df8a6d02f";
      "kwinrc"."Desktops"."Id_3" = "e9590b58-c9bb-47d5-b15d-32e3adf84d6b";
      "kwinrc"."Desktops"."Id_4" = "08641d23-5782-4104-b0bd-7aadaa42a150";
      "kwinrc"."Desktops"."Number" = 4;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Plugins"."fadedesktopEnabled" = true;
      "kwinrc"."Plugins"."slideEnabled" = false;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling/08641d23-5782-4104-b0bd-7aadaa42a150/453d5886-b76a-44bf-8cd1-6c19463fefe7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/08641d23-5782-4104-b0bd-7aadaa42a150/c5e2660f-6bda-4882-b78b-3c6ea5233b50"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/16606567-2f97-4828-9202-fd3df8a6d02f/453d5886-b76a-44bf-8cd1-6c19463fefe7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/16606567-2f97-4828-9202-fd3df8a6d02f/c5e2660f-6bda-4882-b78b-3c6ea5233b50"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e2c279af-7567-41de-8f0f-4372a595b944/453d5886-b76a-44bf-8cd1-6c19463fefe7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e2c279af-7567-41de-8f0f-4372a595b944/c5e2660f-6bda-4882-b78b-3c6ea5233b50"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e9590b58-c9bb-47d5-b15d-32e3adf84d6b/453d5886-b76a-44bf-8cd1-6c19463fefe7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/e9590b58-c9bb-47d5-b15d-32e3adf84d6b/c5e2660f-6bda-4882-b78b-3c6ea5233b50"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
