...
in
{
  ...
  config = lib.mkIf osConfig.services.desktopManager.plasma6.enable {
    # This configuration below is generated by running:
    #
    ...
    programs.plasma = {
      ...
      configFile = {
        ...
        "krunnerrc"."Plugins/Favorites"."plugins" =
          "krunner_sessions,windows,browsertabs,krunner_services,browserhistory,krunner_powerdevil,krunner_systemsettings";
        ...
        "kwinrc"."Tiling/e2c279af-7567-41de-8f0f-4372a595b944/453d5886-b76a-44bf-8cd1-6c19463fefe7"."tiles" =
          "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        "kwinrc"."Tiling/e2c279af-7567-41de-8f0f-4372a595b944/c5e2660f-6bda-4882-b78b-3c6ea5233b50"."tiles" =
          "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
