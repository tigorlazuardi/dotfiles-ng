# This file contains the kdl layout for Zellij with Catppuccin Mocha theme
#
# Don't import this file directly. Use (pkgs.callPackage ./zjstatus.nix {})
{ fetchurl, writeText, ... }:
let
  zj-status = fetchurl {
  ...
  ''
    layout {
        ...
        pane size=1 borderless=true {
            plugin location="file:${zj-status}" {
                // -- Catppuccin Mocha --
